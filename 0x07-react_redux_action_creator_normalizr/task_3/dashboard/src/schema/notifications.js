...
// Function to filter notifications by user
function getAllNotificationsByUser(userId) {
  const notifications = [];

  // Loop through the notifications in normalizedData.entities.notifications
  for (const notificationId in normalizedData.entities.notifications) {
    ...
    // Check if the author of the notification matches the userId
...
const notificationsByUser = getAllNotificationsByUser("5debd764f8452ef92346c772");

console.log(notificationsByUser);

// Export the normalized data and function for testing
